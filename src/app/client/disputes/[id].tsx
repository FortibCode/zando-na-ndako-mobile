...
export default function ClientDisputeDetailScreen() {
  ...
  const handleAttach = async () => {
    ...
    if (!permission.granted) {
      alert(t('clientDisputeDetail.photoPermTitle', 'Permission requise'), t('clientDisputeDetail.photoPermDesc', "L'accès aux photos est nécessaire pour joindre une preuve."));
      return;
    }
    ...
    try {
      ...
      alert('Erreur', err.message || t('clientDisputeDetail.uploadError', "Impossible d'envoyer cette preuve."));
    } finally {
      setUploading(false);
    }
  };
