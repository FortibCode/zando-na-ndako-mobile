...
export default function VendorSignupStep1Screen() {
  ...
  const handleContinue = () => {
    ...
    router.push('/auth/signup/vendor/step2');
  };
    ...
    <SafeAreaView style={authStyles.screen}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.flex}>
        ...
        <ScrollView contentContainerStyle={authStyles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          <SignupStepper currentStep={1} titles={['Commerçant', 'Boutique', 'Sécurité']} />
          <Text style={styles.title}>Informations du Commerçant</Text>
          <Text style={styles.subtitle}>Identité du responsable légal de la boutique.</Text>
          ...
          <PrimaryButton
            ...
            title="Continuer vers la boutique"
          />
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
