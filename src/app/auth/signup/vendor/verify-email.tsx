...
export default function VendorVerifyEmailScreen() {
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        {status === 'registering' ? (
          ...
          <OtpVerificationLayout
            ...
            canResend={canResend}
            description={<Text>Nous avons envoyé un code de vérification par email. Entrez le code ci-dessous pour continuer.</Text>}
